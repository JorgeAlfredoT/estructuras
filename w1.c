...
struct nodo *posicionInicial(struct nodo *,int ,int);
...
int main(){
  ...
  imprimir(cabeza);
  cabeza=posicionInicial(cabeza,1,36);
  imprimir(cabeza);
...
struct nodo *posicionInicial(struct nodo *cabeza,int posicion ,int valor){
